...
const SECTIONS: { label: string; links: { href: string; label: string; icon: LucideIcon }[] }[] = [
  ...
  },
  {
    ...
    links: [
      ...
      { href: "/users/verification-queue", label: "Passenger verification", icon: ShieldCheck },
      { href: "/users/deletion-requests", label: "Deletion requests", icon: UserX },
  ...
  },
  {
    ...
    links: [
      ...
      { href: "/rides/recurring", label: "Recurring rides", icon: Repeat },
