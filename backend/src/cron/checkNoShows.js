  ...
  for (const [rideId, bookings] of byRide) {
    ...
    for (const booking of bookings) {
      ...
      await notify(booking.passengerId, "NO_SHOW_CANCELLED", "Driver didn't show up",
        "Your driver didn't arrive. Your booking was cancelled and any platform fee refunded.");
    }
    ...
    await notify(driverId, "NO_SHOW_CANCELLED", "Ride auto-cancelled — no-show",
      "Your ride was auto-cancelled because it wasn't started within the no-show grace period after departure time.");
  }
