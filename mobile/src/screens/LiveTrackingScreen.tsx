...
export default function LiveTrackingScreen({ route, navigation }: any) {
  ...
  // No real progress fraction to key this off yet (that needs a route +
  // current position match) — "midway" is an honest placeholder that
  // still reads as "under way" rather than claiming a precision this
  // screen doesn't have.
