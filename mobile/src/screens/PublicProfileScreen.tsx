...
const styles = StyleSheet.create({
  ...
  rating: { ...typography.caption, color: colors.warning, marginTop: spacing.xs },
  since: { ...typography.small, color: colors.textMuted, marginTop: spacing.xs },
  ...
  reviewComment: { ...typography.caption, marginTop: spacing.xs },
  reviewFromRow: { flexDirection: "row", alignItems: "center", justifyContent: "space-between", marginTop: spacing.xs },
